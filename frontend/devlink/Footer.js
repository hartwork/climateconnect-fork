...
export function Footer({ as: _Component = _Builtin.Section, link }) {
  return (
    <_Component
            ...
            >
              ...
              >
                <_Builtin.Link
                  ...
                  block=""
                  options={{
                    href: "https://climateconnect.earth/de/browse",
                    target: "_blank",
                  }}
                >
                  {"Projekte"}
              ...
              >
                <_Builtin.Link
                  ...
                  block=""
                  options={{
                    href: "https://climateconnect.earth/de/browse#organizations",
                    target: "_blank",
                  }}
                >
                  {"Organisationen"}
              ...
              >
                <_Builtin.Link
                  ...
                  block=""
                  options={{
                    href: "https://climateconnect.earth/de/browse#members",
                    target: "_blank",
                  }}
                >
                  {"Mitglieder"}
      ...
      <_Builtin.Container className={_utils.cx(_styles, "sm-con")} tag="div">
        ...
        >
          <_Builtin.Image
            ...
            height="auto"
            alt="Twitter Logo"
            src="https://uploads-ssl.webflow.com/615d9a37fbb2467a53e09161/6165793f2a213d389ab790e5_Icon%20awesome-twitter.svg"
          />
        </_Builtin.Link>
        <_Builtin.Link
          className={_utils.cx(_styles, "social-media-icons")}
        ...
        >
          <_Builtin.Image
            ...
            height="auto"
            alt="Facebook logo"
            src="https://uploads-ssl.webflow.com/615d9a37fbb2467a53e09161/6165793f7976d967d24705a5_Icon%20awesome-facebook-square.svg"
          />
        </_Builtin.Link>
        <_Builtin.Link
          className={_utils.cx(_styles, "social-media-icons")}
